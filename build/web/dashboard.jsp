  ...
  <div class="carousel-inner">
    <div class="item active">
      ...
      <div class="carousel-caption" style="color:black">
          ...
          <form >
              <>
         <a href="#"><h4>those who have not submitted fine yet, submit last by this friday</h4></a>
        <a href="#"><h4>rooms whose maintainence is needed add complaint</h4></a>
        <a href="#"><h4>keep cleanliness in the hostel corridor</h4></a>
        <a href="#"><h4>student should switch off their lights and fans after they leave their room </h4></a>
        <a href="#"><h4>no creating indiscipline in hostel</h4></a>
        <a href="#"><h4>students who are not taking care of hostel belongings will be fined</h4></a>
        <a href="#"><h4>do not create indiscipline in hostels</h4></a>
        <a href="#"><h4>lights should be switched off after 12 o'clock</h4></a>
        <a href="#"><h4>use water wisely</h4></a>
        <a href="#"><h4>seating plan for sessional test(batch 2016)</h4></a>
...
<div class="container">
  <div style="text-align:center">
    ...
    <div>
      <h4>girls hostel warden: </h4>
      <ul><li>name :manjeet kaur</li>
          <li>phn no:981763456</li>
          <li>email:kalpanahstl@chitkara.edu.in</li>
      </ul>
    </div>
    <div class='contact'>
         <h4>college authorities: </h4>
      <ul><li>Dean student welfare :cl. kulwant singh</li>
          <li>phn no:927455373</li>
          <li>email:kulwantsingh@chitkara.edu.in</li>
      </ul>
    </div>
    <div class='cont'>
         <h4>Boys hostel warden: </h4>
      <ul><li>nmae:balvinder singh</li>
          <li>phn no:6798465373</li>
          <li>email:balusingh@chitkara.edu.in</li>
      </ul>
    </div>
